...
1. RIM-002: Record architecture decision log (ADRs)
...
1. RIM-003: Define run-state vocabulary and terminal statuses
...
1. RIM-004: Add implementation tracker doc
...
1. RIM-102: Remove task-domain commands and providers
...
1. RIM-105: Preserve packaging and baseline tests
...
1. RIM-204: Implement `LoopExplorerProvider`
...
1. RIM-205: Add starter workflow templates
...
1. RIM-302: Implement state-machine engine
...
1. RIM-303: Add command step executor
...
1. RIM-306: Add cancellation and failure-stop reasons
...
1. RIM-402: Implement Copilot adapter (preview-safe)
...
1. RIM-403: Add agent step node type
...
1. RIM-404: Implement repair loop semantics
...
1. RIM-405: Capture agent claims separately from evidence
...
1. RIM-502: Build Evidence Explorer
...
1. RIM-503: Improve diagnostics and deep-link integration
...
1. RIM-504: Add run summary report generation
...
1. RIM-602: Route command and agent steps through isolation context
...
1. RIM-603: Add isolation visibility in UI
...
1. RIM-604: Add diff evidence for isolated runs
...
1. RIM-702: Resilience and recovery testing
...
1. RIM-706: Release checklist and go/no-go gate
